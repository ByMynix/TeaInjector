    ...
    public partial class Form1 : PoisonForm
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                PoisonMessageBox.Show(this, "New update available! The Updater will start automatically after clicking 'Ok'.", "TeaInjector: Update-Checker", MessageBoxButtons.OK, MessageBoxIcon.Question);
            ...
            else
            {
                ...
                IWshRuntimeLibrary.IWshShortcut shortcut = wsh.CreateShortcut(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\TeaInjector.lnk") as IWshRuntimeLibrary.IWshShortcut;
                shortcut.TargetPath = AppPath + @"\TeaInjector.exe";
                shortcut.WindowStyle = 1;
                shortcut.WorkingDirectory = AppPath;
                shortcut.IconLocation = AppPath + @"\TeaInjector.exe";
                shortcut.Save();
            }
...
+ "", "[How to Use]");
        ...
        {
            Process.Start("https://bymynix.de/teainjector/");
        }
        ...
        private void poisonToggle1_Click(object sender, EventArgs e)
        {
            if (poisonToggle1.Checked == false)
            {
                ...
                poisonToggle1.Checked = false;
                Properties.Settings.Default.Save();
                if (System.IO.File.Exists(Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory) + @"\TeaInjector.lnk"))
                    System.IO.File.Delete(Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory) + @"\TeaInjector.lnk");
            }
        ...
        {
            string url = "https://bymynix.de/teainjector/Changelogs.txt";
            try
            {
        ...
        private void poisonButton2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    PoisonMessageBox.Show(this, "Successfully injected!", "TeaInjector: Injection", MessageBoxButtons.OK, MessageBoxIcon.Question);
                }
                else
                {
