...
--------------")
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If "No Updates available!" = client.DownloadString("https://bymynix.de/teainjector/Update%20Checker%201.3.txt") Then
    ...
    Private Sub MetroButton4_Click(sender As Object, e As EventArgs) Handles MetroButton4.Click
        Dim url As String = "https://bymynix.de/teainjector/Changelogs.txt"
        Try
