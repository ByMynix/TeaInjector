Public Class Form2
    Private Sub Form2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim uri As System.Uri = New System.Uri("https://teainjector.bymynix.xyz/TeaInjector%20Setup.exe")
        Dim webclient As System.Net.WebClient = New System.Net.WebClient()

        Dim path As String = New String(System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "C:\TeaInjector\Updater.exe"))
    ...
    Private Sub webclient_DownloadDataCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.AsyncCompletedEventArgs)
        ...
        Try
            Process.Start("C:\TeaInjector\Updater.exe")
